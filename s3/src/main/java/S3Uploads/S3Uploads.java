...
public class S3Uploads extends HttpServlet
{
    ...
    final static String AWS_SECRET_KEY = "Z7WxIyDdB6XiAv2OZI+/7vBBeAVNpIl5dZJIFGwx";

    // You will need to use your own public key here.
    final static String AWS_PUBLIC_KEY = "AKIAIP5VG4M5JBVQJAWQ";
...
//                response.addProperty("invalid", true);
    ...
    private String base64EncodePolicy(String policyJsonStr) throws UnsupportedEncodingException
    {
    ...
    public String signV2(String policy){
    	
    	String base64Policy;
    	String signature="";
		try {
			base64Policy = base64EncodePolicy(policy);
			signature = sign(base64Policy);
    ...
    public static void main(String[] args) {
    	...
    	Reader r;
    	try {
    		//r= new FileReader("policy.json");
    		String policy = new String(Files.readAllBytes(Paths.get("E:/workspace/glodon-s3/src/main/resources/policy.json")));
    		System.out.println(policy);
    		S3Uploads su = new S3Uploads();
    		String policyB64 = su.base64EncodePolicy(policy);
    		System.out.println(policyB64);
    		su.signV2(policy);
    		System.out.println(su.signV2(policy));
